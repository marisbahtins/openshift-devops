  ...
  spec:
    ...
    strategy:
      ...
      jenkinsPipelineStrategy:
        jenkinsfilePath: Jenkinsfile-parksmap
kind: List
...
- kind: "BuildConfig"
  ...
  spec:
    ...
    strategy:
      type: "JenkinsPipeline"
      jenkinsPipelineStrategy:
        jenkinsfilePath: Jenkinsfile-mlbparks
kind: List
metadata: []" | oc create -f - -n ${GUID}-jenkins
...
- kind: "BuildConfig"
  ...
  spec:
    ...
    strategy:
      type: "JenkinsPipeline"
      jenkinsPipelineStrategy:
        jenkinsfilePath: Jenkinsfile-nationalparks
kind: List
metadata: []" | oc create -f - -n ${GUID}-jenkins
